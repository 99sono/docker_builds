...
2. `03_verify_java_install.sh` - Java 25 validation
3. `04_verify_miniforge_install.sh` - Miniforge/Python check
4. `05_verify_nodejs_install.sh` - Node.js 24.14.0 validation
...
for script in 03_verify_java_install.sh 04_*.sh 05_*.sh 06_*.sh; do
    echo "=== Running $script ==="
